...
Odeo.prototype.getUI = function() {
	...
	var code = '<style>.odeo-player{position:absolute;left:20px; bottom:20px; z-index:1000;}.odeo-player *{all:unset;font-size: 12px}</style>';
	code += '<style>.odeo-button, .odeo-input{height: 28px;line-height: 28px;border: 1px solid white; display: inline-block; padding: 0 .5em; opacity: .5; cursor: pointer}</style>';
